...
//v.clear & v.empty name er 2tah function ache
//v.clear die size 00 koreh pelah jai ,tobhe caile jhor koreh value acccees korah jai
//v.empty die chek koreh jeh vector tah kahli kina,khali hokle retun true ,nah holhe false.
}
